...
/**
 Presents the Core Push inbox modally, using the View Controller stored via +[Carnival setPresentingViewController], and uses the rootViewController if not set
