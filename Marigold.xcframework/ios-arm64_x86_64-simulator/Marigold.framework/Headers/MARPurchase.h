...
@interface MARPurchase : NSObject
 ...
 */
@property (strong, nonatomic, readonly) NSArray<MARPurchaseItem *> *purchaseItems;
 ...
 */
@property (strong, nonatomic, readonly) NSMutableArray<MARPurchaseAdjustment *> *purchaseAdjustments;
 ...
 * @return MARPurchase instance. Will return nil if purchase items array is nil.
 */
- (nullable instancetype)initWithPurchaseItems:(NSArray<MARPurchaseItem *> *)purchaseItems;
 ...
 */
- (void)addPurchaseAdjustment:(MARPurchaseAdjustment *)purchaseAdjustment;
 ...
 */
- (void)setAllPurchaseAdjustments:(NSArray<MARPurchaseAdjustment *>*)purchaseAdjustments;
