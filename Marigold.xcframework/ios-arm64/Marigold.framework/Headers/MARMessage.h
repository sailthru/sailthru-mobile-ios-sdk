...
/**
 * Declares which type the MARMessage is. Types are defined at time of authoring.
 **/
typedef NS_ENUM(NSInteger, MARMessageType) {
    MARMessageTypeText,
    MARMessageTypeImage,
    MARMessageTypeLink,
    MARMessageTypeVideo,
    MARMessageTypeStandardPush,
    MARMessageTypeOther
};

@interface MARMessage : NSObject
 ...
 */
@property (nonatomic, assign) MARMessageType type;
