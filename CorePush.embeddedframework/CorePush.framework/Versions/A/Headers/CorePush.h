...
/**
 Sets the CorePush appKey credentials for this app.
...
/**
 Sets the CorePush appKey credentials for this app, and the UIRemoteNotificationType at the same time.
 @param appKey The appKey you recieved when setting up your app at http://www.corepush.com 
...
/**
 Asyncronously sets the tags for CorePush for this Device.  
...
/** 
 Asyncronously sets the tags for CorePush for this Device, with no callback block.  
 @param tags An array of tags for this device. A nil value or an empty NSArray will clear the tags for this Device.
 @discussion Calling this method will overwrite any previously set tags for this Device.
 */
...
/**
 Asyncronously adds the tag to CorePush for this Device.  If the tag is already registered with Core Push, this method does not add the tag again.
...
/**
 Asyncronously gets the tags for CorePush for this Device.
 @param block The block returned from the asyncronous call containing either an NSArray of tags, or an NSError if there was one.
 */
